<div class="container py-16 md:py-20" id="work">
    ...
    <div class="relative mx-auto mt-12 flex w-full flex-col lg:w-2/3">
        ...
        <div class="mt-8 flex flex-col text-center md:flex-row md:text-left">
          ...
          <span class="shrink-0">
            <img src="{{Vite::asset('resources/assets/img/logo-spotify.svg')}}" class="h-auto w-32" alt="company logo" />
          </span>
        ...
        <div class="mt-8 flex flex-col text-center md:flex-row md:text-left">
            <div class="md:w-2/5">
                <div class="flex justify-center md:justify-start">
          <span class="shrink-0">
            <img src="{{Vite::asset('resources/assets/img/logo-microsoft.svg')}}" class="h-auto w-32" alt="company logo" />
          </span>
                    <div class="relative ml-3 hidden w-full md:block">
                        <span class="absolute inset-x-0 top-1/2 h-0.5 -translate-y-1/2 transform bg-grey-70"></span>
                    </div>
        ...
        <div class="mt-8 flex flex-col text-center md:flex-row md:text-left">
            <div class="md:w-2/5">
                <div class="flex justify-center md:justify-start">
          <span class="shrink-0">
            <img src="{{Vite::asset('resources/assets/img/logo-fedex.svg')}}" class="h-auto w-32" alt="company logo" />
          </span>
                    <div class="relative ml-3 hidden w-full md:block">
                        <span class="absolute inset-x-0 top-1/2 h-0.5 -translate-y-1/2 transform bg-grey-70"></span>
                    </div>
